                ...
                <div class="row">
                    <div class="col-xs-12 col-sm-12 col-md-10 col-md-push-1 m-b-70">
                        <div class="row">
                            ...
                            <div class="col-sm-4">
                                <h5 class="text-xs-center text-right text-gray"><%=good.getType().getTypeName()%> <img src="../img/phone.png" class="h-30 align-text-bottom m-l-20" alt="" /></h5>
                            </div>
                        </div>
                                ...
                                <div role="tabpanel">
                                    ...
                                    <div class="tab-content">
                                        ...
                                        <div class="tab-pane" id="tab2">
                                            <dl class="dl-horizontal">
                                                <dt>操作系统</dt><dd><%=productDetails.getOs()%></dd>
