        ...
        <div class="navbar-collapse">
            <nav class="cbp-spmenu cbp-spmenu-vertical cbp-spmenu-left" id="cbp-spmenu-s1">
                <ul class="nav" id="side-menu">
                    ...
                    <li>
                        <a href="AdminInfo.jsp" style="font-family:'楷体" class="active"><i class="fa fa-check-square-o nav_icon"></i>我的信息<span class="fa arrow"></span></a>
                        <ul class="nav nav-second-level collapse" style="font-family:'楷体">
                            <li>
                ...
                <div class="container" style="width:90%">
                    ...
                    <div class="w3l-banner-grids">
                        ...
                        <div class="col-md-4 w3ls-banner-left">
                            ...
                            <div class="w3ls-banner-left-info">
                                <h4>邮箱</h4>
                                <p><a href="mailto:example@email.com" style="font-family:'calisto mt'">mail@example.com</a></p>
                            </div>
                        </div>
                        <div class="clearfix"> </div>
                    </div>
