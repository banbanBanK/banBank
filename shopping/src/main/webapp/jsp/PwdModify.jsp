        ...
        <div class="navbar-collapse">
            <nav class="cbp-spmenu cbp-spmenu-vertical cbp-spmenu-left" id="cbp-spmenu-s1">
                <ul class="nav" id="side-menu">
                    ...
                    <li>
                        <a href="#" style="font-family:'楷体"><i class="fa fa-file-text-o nav_icon"></i>价格调整<span class="nav-badge-btm">02</span><span class="fa arrow"></span></a>
                    ...
                    <li>
                        <a href="#" style="font-family:'楷体" class="active"><i class="fa fa-check-square-o nav_icon"></i>我的信息<span class="fa arrow"></span></a>
                        <ul class="nav nav-second-level collapse" style="font-family:'楷体">
                            <li>
                    ...
                    <li>
                        <a href="#" style="font-family:'楷体"><i class="fa fa-cogs nav_icon" ></i>设置<span class="nav-badge">12</span> <span class="fa arrow"></span></a>
                        <ul class="nav nav-second-level collapse" style="font-family:'楷体">
                            <li>
