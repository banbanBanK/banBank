...
<div class="content-right">
    <div class="container m-t-100 m-b-100">
        <div class="row m-b-70">
            <div class="col-sm-8">
                <h1 class="text-xs-center">所有商品</h1>
            </div>
            <div class="col-sm-4">
                <h5 class="m-t-10 text-xs-center text-right text-gray">所有商品<img src="../img/computer.png" class="h-30 align-text-bottom m-l-20" alt="" /></h5>
            </div>
        ...
        <%
            ...
            if(goods.size() != 0){
                for(int i=0;i<(goods.size()- goods.size()%4)/4;i++){
        %>
        <div class="row">
            <%
