...
<div class="menu-left hidden-xs">
    <a href="front.jsp" class="logo-left">
        <img src="../img/logo.png" alt="" />
    </a>

    <div class="nav-item">
        <a href="AdminInfo.jsp" class="text-primary">
...
<div id="sidenav" class="side-nav">
    ...
    <div class="account-side-btn visible-xs">
        <a href="front.jsp"><i class="fas fa-user-circle"></i></a>
    </div>

    <div class="home-side-btn visible-xs">
        <a href="front.jsp"><i class="fas fa-desktop"></i></a>
    </div>

    <ul>
        <li><a href="AdminInfo.jsp">Over-ear <img src="../img/icon-headphones.png" class="h-30 align-middle m-l-20" alt="" /></a></li>
        <li><a href="AdminInfo.jsp">On-ear <img src="../img/icon-headphones.png" class="h-30 align-middle m-l-20" alt="" /></a></li>
        <li><a href="AdminInfo.jsp">In-ear <img src="../img/icon-headphones.png" class="h-30 align-middle m-l-20" alt="" /></a></li>
        <li><a href="AdminInfo.jsp">Accessories <img src="../img/icon-headphones.png" class="h-30 align-middle m-l-20" alt="" /></a></li>

        <li><hr class="m-tb-30" /></li>

        <li><a href="AdminInfo.jsp">Products</a></li>
        <li><a href="AdminInfo.jsp">Product Details</a></li>
        <li><a href="AdminInfo.jsp">About</a></li>
        <li><a href="AdminInfo.jsp">Blog</a></li>
        <li><a href="AdminInfo.jsp">Blog Post</a></li>
        <li><a href="AdminInfo.jsp">Contact</a></li>
    </ul>
        ...
        <div class="carousel-inner" role="listbox">
            ...
            <div class="item">
                ...
                <div class="carousel-caption text-xs-center text-sm-center text-md-center text-left">
                    ...
                    <a href="AdminInfo.jsp" class="btn btn-success"><i class="fas fa-rocket"></i>&nbsp; Explore</a>
                </div>
            </div>
